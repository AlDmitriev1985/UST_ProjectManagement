...
{
    public class UST_MinimizeButton : Control
    {
        #region --- Settings ---
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            graph.DrawLine(new Pen(UST_IconColor, UST_IconLineSize), UST_IconOffset, (Height - 1) / 2, Width - UST_IconOffset - 1, (Height - 1) / 2);
